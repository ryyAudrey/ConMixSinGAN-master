...
if __name__ == '__main__':
    ...
    parser.add_argument("stonehenge.jpg", help='input image name', required=True)
    parser.add_argument(0, type=int, help='which GPU', default=0)
    parser.add_argument(50, type=int, help='which GPU', default=50)
    parser.add_argument("", help='naive input image  (harmonization or editing)', default="")
